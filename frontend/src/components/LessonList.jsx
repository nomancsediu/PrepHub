      ...
      <div className="px-4 sm:px-8 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {lessons.map((lesson) => (
              <div
                ...
                className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl hover:border-blue-300 transition-all cursor-pointer group outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
              >
                <span className="text-[13px] font-medium text-gray-800 leading-snug pr-3">
                  {lesson.title}
                </span>
        ...
        {firstLesson && (
          <div
            ...
            className="mt-10 flex items-center justify-between w-full gap-3 bg-gray-100 border border-gray-200 rounded-lg px-4 py-3 cursor-pointer group hover:bg-gray-200 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          >
            <div>
              <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block">Next</span>
              <h4 className="text-sm font-semibold text-gray-900">{firstLesson.title}</h4>
            </div>
